...
<title>Werkwinkel – Innovativ und zukunftsorientiert</title>
...
<meta name="apple-mobile-web-app-title" content="Werkwinkel" />
<link rel="manifest" href="/site.webmanifest" />
@vite('resources/css/app.css')
@livewireStyles
</head>
<body class="antialiased font-figtree font-normal text-black text-base md:text-md leading-[1.3] flex min-h-full flex-col">

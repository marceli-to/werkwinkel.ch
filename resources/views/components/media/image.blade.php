...
<figure class="{{ $class }}">
  <picture>
    @if (in_array('xl', $sizes))
      <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-xl.avif" type="image/avif">
      <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-xl.jpg">
    @endif
    @if (in_array('lg', $sizes))
      <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-lg.avif" type="image/avif">
      <source media="(min-width: 1280px)" srcset="/media/img/{{ $image }}-lg.jpg">    
    @endif
    @if (in_array('md', $sizes))
      <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-md.avif" type="image/avif">
      <source media="(min-width: 1024px)" srcset="/media/img/{{ $image }}-md.jpg">    
    @endif
    @if (in_array('sm', $sizes))
      <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-sm.avif" type="image/avif">
      <source media="(min-width: 768px)" srcset="/media/img/{{ $image }}-sm.jpg">    
    @endif
    <source media="(min-width: 1440px)" srcset="/media/img/{{ $image }}-xs.avif" type="image/avif">

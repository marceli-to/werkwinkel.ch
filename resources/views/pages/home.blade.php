  ...
  <x-layout.inner>
    ...
    <div class="md:grid md:grid-cols-12 md:gap-20">
      <div class="md:col-span-8 hyphens-auto">
        <p>Der Montag, 20. Januar 2025, markiert den Start für den Bau des Innovationsparks «Werkwinkel» für Startups und zukunftsorientierte Unternehmungen. Die Firma consqwnt AG und deren Eigentümer Jannine und Daniel Roner realisieren auf gut 3’000 m² Bauland, mit der Gesamtleitung der Sanjo Management AG, eine moderne Gewerbehalle inmitten von Wolfhausen ZH in der Gemeinde Bubikon. Dabei wird die bestehende Überbauung Obstwinkel mit der Erstellung vom Werkwinkel ergänzt und abgeschlossen.</p>
        <p>In den rund <strong>16’000 m<sup>3</sup> Bauvolumen</strong> entstehen <strong>1’400 m<sup>2</sup> Gewerbeflächen sowie 600 m<sup>2</sup> Büroflächen</strong>, welche nach den Bedürfnissen der künftigen Mieter eingeteilt werden können. Das modulare Konzept, in Verbindung mit einer hochwertigen Architektur, bietet Mietern die nötige Flexibilität, die Innenräume nach ihren individuellen Wünschen zu gestalten.</p>
      ...
      <div class="hidden md:block mt-20 md:mt-0 md:col-span-4">
        <x-media.image 
          :image="'werkwinkel-innen'" 
          :sizes="['sm']"
          :width="900"

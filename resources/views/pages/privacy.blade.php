  ...
  <x-layout.inner class="privacy">
    <div class="max-w-6xl mx-auto px-15 lg:px-30 py-25 lg:py-50 ">
      <h1>Datenschutzerklärung</h1>
        ...
        <p>Diese Daten sowie alle Daten dieser Website werden bei unserem Hosting-Provider webkeeper GmbH, 8604 Volketswil, Schweiz gespeichert, deren Datenschutzerklärung Sie <a href="https://www.webkeeper.ch/de/unternehmen/datenschutz"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">hier</a> finden.</p>
        ...
        <p>Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per E-Mail an <a href="mailto:info@sanjo.ch" class="underline underline-offset-4 decoration-1 hover:no-underline" title="E-Mail">info@sanjo.ch</a> zu widerrufen. In einem solchen Fall kann die Konversation nicht fortgeführt werden.</p>
        ...
        <p>Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich werden nutzen können. Sie können darüber hinaus die Erfassung der durch den Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie das unter dem diesem <a href="https://tools.google.com/dlpage/gaoptout?hl=de"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">Link</a> verfügbare Browser-Plugin herunterladen und installieren.</p>
        <p>Mehr Informationen zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in der Datenschutzerklärung von <a href="https://support.google.com/analytics/answer/6004245?hl=de"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">Google</a></p>
        ...
        <p>Zudem erfolgt die Nutzung von Google Maps sowie der über Google Maps erlangten Informationen nach den Google-Nutzungsbedingungen <a href="http://policies.google.com/terms"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">policies.google.com/terms</a> und den Geschäftsbedingungen für <a href="http://www.google.com/intl/de_de/help/terms_maps.html"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">Google Maps</a>.</p>
        <h2>Recht auf Auskunft, Löschung, Sperrung</h2>
        <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an <a href="mailto:info@sanjo.ch "  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">info@sanjo.ch</a> senden.</p>
        ...
        <p>Weitere Informationen zur Datenverarbeitung durch Adobe Fonts finden Sie in der Datenschutzerklärung von Adobe Fonts <a href="https://www.adobe.com/de/privacy/policies/adobe-fonts.html"  class="underline underline-offset-4 decoration-1 hover:no-underline" target="_blank">hier</a>. </p>
